...
<div class="container">
    <div class="row justify-content-md-center">
        <div class="col-md-8">
            <div class="card"> <!--{{ asset($post->image) }}      {{ asset('storage/'.$post->image) }}-->
            ...
            @endauth
            @guest
            <p>Si deseas comentar <a href="{{ action('Auth\LoginController@showLoginForm') }}">incia sesión</a> o <a
                    href="{{ action('Auth\RegisterController@showRegistrationForm') }}"> registrate </a></p>
                    @endguest
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h6 class=" card-subtitle mb-2 text-muted">
                                {{ $comment->created_at->toFormattedDateString() }}</h6>
